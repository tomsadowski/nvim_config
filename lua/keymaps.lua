...
-- lsp
vim.keymap.set({"n"}, "l", "K")          -- view doc under cursor
vim.keymap.set({"n"}, "L", "<C-w>d")     -- view error under cursor

-- window
vim.keymap.set({"n"}, "k",        "<C-w>")  -- window
vim.keymap.set({"n"}, "kk",       "<C-w>w") -- window
vim.keymap.set({"n"}, "k<Left>",  "<C-w>H") -- move window left
vim.keymap.set({"n"}, "k<Down>",  "<C-w>J") -- move window down
vim.keymap.set({"n"}, "k<Up>",    "<C-w>K") -- move window up
vim.keymap.set({"n"}, "k<Right>", "<C-w>L") -- move window right
